...
Analysis Skill zip=https://github.com/foggy-projects/foggy-ai-analysis/releases/download/v0.1.7/foggy-ai-analysis-skill-0.1.7.zip
Analysis Skill manifest=https://github.com/foggy-projects/foggy-ai-analysis/releases/download/v0.1.7/foggy-ai-analysis-skill-0.1.7-manifest.json
Analysis Skill checksum=https://github.com/foggy-projects/foggy-ai-analysis/releases/download/v0.1.7/foggy-ai-analysis-skill-0.1.7-SHA256SUMS
...
The `v0.1.7` package points public onboarding to `foggy-runtime-cli v0.1.12`. This CLI release keeps Runtime API v1 capability preflight and `groupBy` string-array normalization, adds `-help` compatibility, and installs the paired `foggy-ai-analysis` / `foggy-semantic-query` Skills under `~/.agents/skills`.
