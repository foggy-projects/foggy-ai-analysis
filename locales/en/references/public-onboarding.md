...
Download and verify the Java launcher release assets from `runtime-api-launcher-v0.1.3`. Start the runtime on port `18066` unless occupied. If a local debug path is explicitly needed on the maintainer workstation, use:
