...
Public Skill release aligned with `foggy-runtime-cli v0.1.11` and Foggy Runtime Launcher `foggy-runtime-launcher-v0.1.3`.
...
- Points launcher guidance to `foggy-runtime-launcher-v0.1.3`.
...
- Runtime smoke evidence should use `foggy-runtime-launcher-v0.1.3` and include a Runtime API-managed MySQL datasource restart/persistence check.
